  ...
  function validateStep(s) {
    ...
    if (s === 2) {
      ...
      if (form.age !== "") {
        ...
        if (!Number.isInteger(age) || age < 13 || age > 120) errs.age = "Enter an age between 13 and 120";
      }
      if (form.birthDate) {
          ...
          <div className="reg2-form-wrap">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className={`reg2-step ${step === 2 ? "active" : ""}`}>
                ...
                <div className={`reg2-field ${hasError("age") ? "err" : ""} ${isFocused("age") ? "focused" : ""}`}>
                  <label>Age</label>
                  <div className="reg2-input-box">
                    <input
                      type="number"
                  ...
                  {errors.age && <span className="reg2-field-err">{errors.age}</span>}
                </div>
