...
import { BsCalendar3, BsHeart, BsHeartFill, BsGeoAlt, BsLock } from "react-icons/bs";
    ...
    <article className="event-card" style={{ animationDelay: `${delay}s` }}>
      <Link to={`/events/${event.id}`} className="event-card-link">
        <div className="event-card-media">
          ...
          {event.visibility === "private" && <span className="event-card-type private"><BsLock /> Private</span>}
        </div>
